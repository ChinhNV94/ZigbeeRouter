...
//                                            Send_HTE(HTE_RESPONSE_CLUSTER, MSB, LSB);
                                    ...
                                    {
//                                        if(params.APSDE_DATA_indication.DstAddress.ShortAddr.Val == 0x0001)
...
void ProcessNONZigBeeTasks(void)
{
    ...
    // *********************************************************************
        ...
        if(WSANFlags.bits.EnableGetDataHTE | WSANFlags.bits.EnableGetDataHTE5M)
        {
...
//    sendReset();
    ...
    sendPhotoSize();
    //lenh thiet lap lai ti so nen anh
    sendCompressRate();
   }
/********************/
...
void Take_photo(void){
    sendStartPhoto();
    sendGetLength();
//    buffer = (BYTE*)calloc(length_data,sizeof(BYTE));
